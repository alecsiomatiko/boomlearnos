...
export default function DashboardLayout({
  ...
  // Don't show sidebar on the main dashboard selector page
  const isMainDashboard = pathname === "/dashboard"

  // Redirect employees from main dashboard to control panel
  useEffect(() => {
    if (user && user.role === 'user' && isMainDashboard) {
      router.push('/dashboard/control')
    }
  }, [user, isMainDashboard, router])
